...
namespace Project.Api.XUnit.Project.Api.Application.AppProject
{
    public class GetPerformanceReportQueryTest
    {
        ...
        public void Validate_WhenNotImplemented_ShouldBeValid()
        {
            ...
            var query = new GetPerformanceReportQuery()
            {
                UserUuid = Guid.Parse("d2f8b1c4-3c5e-4f9a-8b6e-7f8c9d0e1f2a")
            };
        ...
        public void Validate_UuidProject_GuidNOk_Zero()
        {
            ...
            var query = new GetPerformanceReportQuery()
            {
                UserUuid = Guid.Parse("00000000-0000-0000-0000-000000000000"),
            };
            ...
            Assert.True(_notification[0].Message.Contains("User UUID must be a valid GUID"));
        }
    }
}
