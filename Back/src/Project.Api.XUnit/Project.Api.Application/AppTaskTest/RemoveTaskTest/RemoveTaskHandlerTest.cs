...
namespace Project.Api.XUnit.Project.Api.Application.AppProject.CreateProject
{
    public class RemoveTaskHandlerTest
    {
        ...
        private RemoveTaskQuery command = new RemoveTaskQuery
        {
        ...
        private ProjectEntity project = new ProjectEntity()
        {
            ...
            Tasks = new List<TaskEntity>()
            {
                new TaskEntity()
                {
                    ...
                    Description = "A valid task description",
                    ExpirationDate = DateTime.Now.Date.AddDays(7),
                    Status = StatusTaskType.Completed,
                    AuthorId = 1,
                    ProjectId = 1
                }
            },
        ...
        public RemoveTaskHandlerTest()
        {
            ...
            _handler = new RemoveTaskHandler(_taskRepositoryMock.Object,
        ...
        [Fact]
        public async Task Handle_ValidRemove_ShouldBeValid()
        {
            ...
            _taskRepositoryMock.Setup(r => r.Update(It.IsAny<Task>())).ReturnsAsync(true);
        ...
        [Fact]
        public async Task Handle_ValidRemove_ShouldBeInvalid_UserNotFound()
        {
        ...
        [Fact]
        public async Task Handle_ValidRemove_ShouldBeInvalid_TaskNotFound()
        {
            _userRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(user);
            ...
            _userRepositoryMock.Verify(r => r.GetByUuid(It.IsAny<Guid>()), Times.Never);
            _taskRepositoryMock.Verify(r => r.GetByUuid(It.IsAny<Guid>()), Times.Once);
            _projectRepositoryMock.Verify(r => r.GetById(It.IsAny<long>()), Times.Never);
            _taskAuditRepositoryMock.Verify(r => r.Add(It.IsAny<TaskAuditEntity>()), Times.Never);
            _taskRepositoryMock.Verify(r => r.Update(It.IsAny<TaskEntity>()), Times.Never);
        ...
        [Fact]
        public async Task Handle_ValidRemove_ShouldBeInvalid_ProjectNotFound()
        {
            _userRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(user);
            _taskRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(tasks);
        ...
        [Fact]
        public async Task Handle_ValidRemove_ShouldBeInvalid_TaskAuditNotFound()
        {
            _userRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(user);
            _taskRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(tasks);
            _projectRepositoryMock.Setup(r => r.GetById(It.IsAny<long>())).ReturnsAsync(project);
        ...
        [Fact]
        public async Task Handle_ValidRemove_ShouldBeInvalid_ProjetsGetMore20Tasks()
        {
            _userRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(user);
            _taskRepositoryMock.Setup(r => r.GetByUuid(It.IsAny<Guid>())).ReturnsAsync(tasks);
