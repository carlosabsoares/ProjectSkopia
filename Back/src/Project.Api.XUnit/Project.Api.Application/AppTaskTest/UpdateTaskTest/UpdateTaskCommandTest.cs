...
namespace Project.Api.XUnit.Project.Api.Application.AppProject
{
    public class UpdateTaskCommandTest
    {
        ...
        public void Validate_WithValidData_ShouldBeValid()
        {
            ...
            Assert.NotEqual(Guid.Empty, command.Uuid);
            Assert.NotEqual(Guid.Empty, command.EditorUuid);
            Assert.Equal(command.Uuid, Guid.Parse("cc393ae2-8227-4df7-9da5-fb996a2b9af7"));
            Assert.Equal(command.EditorUuid, Guid.Parse("c95ae459-757f-4e6a-9d64-c943146f138c"));
